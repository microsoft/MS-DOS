...
# Άδεια
Όλα τα αρχεία σε αυτό το ταμείο υπόκεινται στην [Άδεια MIT (OSI)](https://en.wikipedia.org/wiki/MIT_License) σύμφωνα με την αποθηκευμένη [Άδεια](https://github.com/Microsoft/MS-DOS/blob/master/LICENSE.md) στη ρίζα αυτού του ταμείου.
