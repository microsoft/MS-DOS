...
# گواهی‌نامه
همه ی فایل های موجود در این ریپازیتوری تحت [گواهی‌نامه MIT (OSI)]( https://en.wikipedia.org/wiki/MIT_License) منتشر شده که با عنوان [فایل گواهی‌نامه](https://github.com/Microsoft/MS-DOS/blob/master/LICENSE.md) در ریشه این مخزن ذخیره شده است.
