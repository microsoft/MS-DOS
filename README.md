...
# License
All files within this repo are released under the [MIT (OSI) License]( https://en.wikipedia.org/wiki/MIT_License) as per the [LICENSE file](https://github.com/microsoft/msdos/license.txt) stored in the root of this repo.
