...
Sin embargo, si deseas enviar contenido adicional que no sea código o modificaciones a archivos que no sean de código fuente (por ejemplo, este archivo README), por favor envía una petición de cambio (PR) que la revisaremos y consideraremos.
