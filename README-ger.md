...
Diese repo enthält den originalen Quellcode und kompilierte Binärdatein für MS-DOS v1.25 und MS-DOS v2.0.
...
# Lizenz
Alle veröffentlichte Dateien innerhalb dieses Repos sind unter der [MIT (OSI) License]( https://en.wikipedia.org/wiki/MIT_License) gemäß der [LICENSE file](https://github.com/Microsoft/MS-DOS/blob/master/LICENSE.md) in dieser Repo gespeichert.
